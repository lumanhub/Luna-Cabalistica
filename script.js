:root {
  ...
  --border-red: rgba(226, 31, 54, 0.32);
...
.btn {
  ...
  border-radius: 999px;
  font-weight: 700;
  transition: transform var(--transition), box-shadow var(--transition), background var(--transition), border var(--transition), filter var(--transition);
...
.btn-primary:hover {
  box-shadow: 0 18px 42px rgba(211, 17, 43, 0.42);
}
...
.tree-life {
  ...
  height: 430px;
  margin: 0 auto;
  filter: drop-shadow(0 0 24px rgba(226, 31, 54, 0.22));
...
.tree-aura {
  position: absolute;
  inset: 10px 48px 22px;
  border-radius: 999px;
  border: 1px solid rgba(255,255,255,0.04);
  box-shadow:
    0 0 0 18px rgba(226, 31, 54, 0.03),
...
.tree-line {
  ...
  background: linear-gradient(
    90deg,
    rgba(255, 243, 214, 0.35),
    rgba(255, 224, 165, 0.98),
    rgba(255, 224, 165, 0.78)
  );
  transform-origin: left center;
  box-shadow: 0 0 10px rgba(255, 215, 140, 0.22);
  border-radius: 999px;
}

.l1  { width: 74px; left: 145px; top: 38px;  transform: rotate(144deg); }
.l2  { width: 74px; left: 145px; top: 38px;  transform: rotate(36deg); }
.l3  { width: 74px; left: 74px;  top: 110px; transform: rotate(0deg); }
.l4  { width: 72px; left: 110px; top: 74px;  transform: rotate(90deg); }
.l5  { width: 76px; left: 110px; top: 146px; transform: rotate(132deg); }
.l6  { width: 76px; left: 144px; top: 146px; transform: rotate(48deg); }
.l7  { width: 72px; left: 145px; top: 182px; transform: rotate(90deg); }
.l8  { width: 74px; left: 74px;  top: 255px; transform: rotate(0deg); }
.l9  { width: 76px; left: 110px; top: 218px; transform: rotate(48deg); }
.l10 { width: 76px; left: 145px; top: 218px; transform: rotate(132deg); }
.l11 { width: 108px; left: 145px; top: 255px; transform: rotate(90deg); }
.l12 { width: 74px; left: 110px; top: 364px; transform: rotate(0deg); }
...
.sephira {
  ...
  height: 30px;
  border-radius: 50%;
  border: 1px solid rgba(255, 245, 220, 0.70);
  box-shadow:
    0 0 0 7px rgba(255,255,255,0.02),
    0 0 14px currentColor,
    0 0 28px currentColor,
    0 0 44px color-mix(in srgb, currentColor 55%, #ffe7a8);
  animation: sephiraPulse 3.2s ease-in-out infinite;
}
...
.sephira::before {
  ...
  border-radius: 50%;
  background:
    radial-gradient(circle at 35% 35%, rgba(255,255,255,0.95), rgba(255,255,255,0.20) 26%, currentColor 62%, rgba(0,0,0,0.18) 100%);
}

/* Cores conforme a imagem enviada */
.s1  { top: 10px;  left: 130px; color: #f4f1ea; } /* branco */
.s2  { top: 82px;  left: 59px;  color: #1d2124; } /* preto */
.s3  { top: 82px;  left: 201px; color: #7f8288; } /* cinza */
.s4  { top: 154px; left: 59px;  color: #b6202b; } /* vermelho */
.s5  { top: 154px; left: 130px; color: #e1ba3f; } /* dourado */
.s6  { top: 154px; left: 201px; color: #4ca0ea; } /* azul */
.s7  { top: 227px; left: 59px;  color: #ff7a1e; } /* laranja */
.s8  { top: 227px; left: 201px; color: #27a95a; } /* verde */
.s9  { top: 300px; left: 130px; color: #6c33aa; } /* roxo */
.s10 { top: 372px; left: 130px; color: #5a3414; } /* marrom */
...
.mini-highlight {
  ...
  padding: 14px 18px;
  border-radius: 999px;
  border: 1px solid rgba(215,160,95,0.22);
...
.audience-yes::before {
  ...
  inset: 0;
  background:
    radial-gradient(circle at top right, rgba(215,160,95,0.16), transparent 28%),
    radial-gradient(circle at bottom left, rgba(226,31,54,0.12), transparent 30%);
  pointer-events: none;
}
...
.audience-no::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at top left, rgba(215,160,95,0.10), transparent 28%);
  pointer-events: none;
}
...
.testimonial-card::before {
  ...
  inset: 0;
  background:
    radial-gradient(circle at top right, rgba(215,160,95,0.08), transparent 30%),
    radial-gradient(circle at bottom left, rgba(226,31,54,0.08), transparent 30%);
  pointer-events: none;
}
...
.testimonial-toggle:hover {
  transform: translateY(-2px);
  border-color: rgba(215,160,95,0.46);
  color: #fff3de;
...
.btn-mystic:hover {
  ...
  box-shadow: 0 0 60px rgba(211, 17, 43, 0.60);
}
...
.btn-animated:hover,
.btn-mystic.btn-animated:hover {
  transform: translateY(-3px) scale(1.02);
  box-shadow:
    0 16px 40px rgba(211, 17, 43, 0.38),
    0 0 25px rgba(255, 200, 120, 0.18);
  filter: brightness(1.05);
}

.btn-animated::before,
.btn-mystic.btn-animated::before {
  content: "";
  position: absolute;
  inset: 0;
  background: linear-gradient(
    ...
    rgba(255,236,200,0.20) 50%,
    rgba(255,255,255,0.08) 60%,
    transparent 80%
  );
  transform: translateX(-140%);
  animation: sheenMove 4.8s linear infinite;
  pointer-events: none;
}
...
@media (max-width: 560px) {
  ...
  .tree-aura {
    inset: 10px 42px 18px;
  }

  .l1  { width: 64px; left: 126px; top: 36px;  transform: rotate(144deg); }
  .l2  { width: 64px; left: 126px; top: 36px;  transform: rotate(36deg); }
  .l3  { width: 64px; left: 62px;  top: 100px; transform: rotate(0deg); }
  .l4  { width: 64px; left: 94px;  top: 68px;  transform: rotate(90deg); }
  .l5  { width: 66px; left: 94px;  top: 132px; transform: rotate(132deg); }
  .l6  { width: 66px; left: 126px; top: 132px; transform: rotate(48deg); }
  .l7  { width: 64px; left: 126px; top: 164px; transform: rotate(90deg); }
  .l8  { width: 64px; left: 62px;  top: 228px; transform: rotate(0deg); }
  .l9  { width: 66px; left: 94px;  top: 196px; transform: rotate(48deg); }
  .l10 { width: 66px; left: 126px; top: 196px; transform: rotate(132deg); }
  .l11 { width: 96px; left: 126px; top: 228px; transform: rotate(90deg); }
  .l12 { width: 64px; left: 94px;  top: 324px; transform: rotate(0deg); }
  ...
  .s1  { top: 8px;   left: 111px; }
  .s2  { top: 72px;  left: 47px; }
  .s3  { top: 72px;  left: 175px; }
  .s4  { top: 136px; left: 47px; }
  .s5  { top: 136px; left: 111px; }
  .s6  { top: 136px; left: 175px; }
  .s7  { top: 200px; left: 47px; }
  .s8  { top: 200px; left: 175px; }
  .s9  { top: 264px; left: 111px; }
  .s10 { top: 328px; left: 111px; }
